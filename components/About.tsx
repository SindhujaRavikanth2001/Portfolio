        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-black text-base md:text-xl max-w-4xl mx-auto mb-8 md:mb-12 leading-relaxed">
              Hello, I'm <span className="text-[#843052] font-semibold">Sindhuja Ravikanth</span>, an AI-focused software engineer with 4.5+ years of experience building agentic AI, RAG pipelines, and cloud-native systems on AWS. With a Master's degree in Computer Science, I work across Java, Python, TypeScript, and React to deliver end-to-end solutions, from scalable backends to thoughtful interfaces. I care about clear architecture, automation, and measurable impact, and I'm looking for opportunities to collaborate and build technology that solves real problems.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-4xl md:text-5xl font-bold text-white">4.5+</span>
                </div>
